...
void hexStringToBinaryArray(const char* aHexString, uint8_t* aBinaryArray) {
...
void binaryArrayToHexString(const uint8_t* aBinaryArray, uint32_t aBinaryArrayLength, char* aHexString) {
