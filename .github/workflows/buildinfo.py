...
include_file.write("const unsigned int buildInfo::mainVersionDigit   = " + latest_release_main + ";\n")
include_file.write("const unsigned int buildInfo::minorVersionDigit  = " + latest_release_minor + ";\n")
include_file.write("const unsigned int buildInfo::patchVersionDigit  = " + latest_release_patch + ";\n")
